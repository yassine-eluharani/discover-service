...
from user_data import TAILORED_DIR, get_resume_text, load_profile
...
def run_tailoring(
    ...
    for job in jobs:
        ...
        try:
            ...
            # PDF generation is on-demand in the backend (scoring/pdf.py
            # uses Playwright). Worker stores text only.
            pdf_path = None
